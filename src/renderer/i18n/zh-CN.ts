const zhCN = {
  ...
  'cloud.goSettings': '前往设置',
  'cloud.syncNow': '立即同步',
  'cloud.syncing': '正在同步...',
  'cloud.lastSync': '上次同步',
  'cloud.account': '账号',
  'cloud.workspace': '工作空间',
  'cloud.database': '数据库',
  'cloud.noteCount': '笔记数',
  'cloud.autoSync': '自动同步',
  'cloud.syncRecords': '最近同步记录',
  'cloud.noRecords': '暂无同步记录',
  'cloud.error.expired': 'Token 已过期，请重新连接',
  'cloud.error.network': '网络错误，请检查网络连接',
  'cloud.feishu': '飞书',
