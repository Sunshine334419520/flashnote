      ...
      {confirming ? (
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <code className={`flex-1 text-[12px] font-mono text-muted-foreground bg-muted/30 rounded-lg px-2 py-1.5 ${revealed ? 'break-all whitespace-normal' : 'truncate'}`}>{revealed ? note.content : '●'.repeat(Math.min(note.content.length, 24))}</code>
