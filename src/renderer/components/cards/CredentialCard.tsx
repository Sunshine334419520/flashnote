    ...
    <div className="rounded-2xl border border-border bg-card p-4 space-y-3 card-hover">
      <div className="flex items-center gap-2 min-w-0">
        ...
        {editing ? (
          ...
          <>
            ...
            <span className="text-[9px] px-1.5 py-0.5 rounded font-medium bg-type-credential/10 text-type-credential shrink-0 select-none">
              {TYPE_LABEL}
            </span>
          </>
        )}
      ...
      {confirming ? (
        <div className="text-center py-2">
          <p className="text-xs text-muted-foreground mb-2">确认删除这条凭据？</p>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 text-[12px] font-mono text-muted-foreground bg-muted/30 rounded-lg px-2 py-1.5 truncate">
              {revealed ? note.content : '●'.repeat(Math.min(note.content.length, 24))}
            </code>
            <button
            ...
            <div className="flex items-center gap-1 shrink-0">
              <button
                ...
                className={cn(
                  ...
                  copied ? 'text-type-credential bg-type-credential/10' : 'text-muted-foreground hover:text-foreground hover:bg-muted'
                )}
              >
